export default function LightDarkButton() {
	return (
		<button
			id="theme-btn"
			className="focus-outline h-6 w-6 hover:rotate-12 hover:text-skin-accent"
			title="Toggles light & dark"
			aria-label="auto"
			aria-live="polite"
		>
			<svg xmlns="http://www.w3.org/2000/svg" id="moon-svg" className="scale-125 sm:scale-100">
			...
			<svg xmlns="http://www.w3.org/2000/svg" id="sun-svg" className="scale-125 sm:scale-100">
